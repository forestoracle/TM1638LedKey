...
/*
  ...
  История:
  0.6 2026-03-24  - функция buttons теперь считывает нажатия клавиш, а getButtons выдзывает её дважды с интервалом DEBOUNCE_DELAY для избежания дребезга 
...
#define DEBOUNCE_DELAY 15  // Задержка между двумя чтениями кнопок дя исключения дребезгп
